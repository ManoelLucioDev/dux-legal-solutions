    ...
    <div >
      ...
      <div className="container-servico">
        <div className="data-services">
          <CardServico serviceImage={adm} title={"TITLE-ADM"} />
        </div>

        <div className="data-services">
          <CardServico serviceImage={consultoria} title={"TITLE-CONSULTANCY"} />
        </div>

        <div className="data-services">
          <CardServico serviceImage={cidadania} title={"TITLE-CITIZENSHIP"} />
        </div>

        <div className="data-services">
          <CardServico serviceImage={advogado} title={"TITLE-ADVOCACY"} />
        </div>

        <div className="data-services">
          <CardServico serviceImage={documento} title={"TITLE-DOCUMENT"} />
        </div>
      </div>
    </div>
  );
